...
class HeaderRenderer private constructor(
     ...
     */
    fun drawHeader(recyclerView: androidx.recyclerview.widget.RecyclerView, canvas: Canvas, header: View, offset: Rect) {
        canvas.save()
     ...
     */
    private fun initClipRectForHeader(clipRect: Rect, recyclerView: androidx.recyclerview.widget.RecyclerView, header: View) {
